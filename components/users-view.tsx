...
export function UsersView() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (editingUser) {
      ...
      if (!result.success) {
        setError(result.error || 'Erro ao cadastrar usuario')
        return
      }
    }
  ...
  const handleDelete = (userId: string) => {
    ...
    if (!result.success) {
      setError(result.error || 'Erro ao deletar usuario')
    }
  ...
  return (
    <div className="space-y-6">
        ...
        <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
          ...
          <DialogContent>
            <DialogHeader>
              ...
              <DialogDescription>
                {editingUser 
                  ? 'Atualize as informacoes do usuario abaixo.' 
      ...
      <div className="grid gap-4 md:grid-cols-3">
        ...
        <Card>
          <CardHeader className="pb-2">
            <CardDescription>Lideres</CardDescription>
